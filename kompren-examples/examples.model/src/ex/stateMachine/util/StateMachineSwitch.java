...
public class StateMachineSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case StateMachinePackage.INPUT_STATE: {
			...
			case StateMachinePackage.OUTPUT_STATE: {
				OutputState outputState = (OutputState)theEObject;
				T result = caseOutputState(outputState);
				if (result == null) result = caseState(outputState);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StateMachinePackage.INIT_STATE: {
				InitState initState = (InitState)theEObject;
				T result = caseInitState(initState);
				if (result == null) result = caseOutputState(initState);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Output State</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Output State</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseOutputState(OutputState object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Standard State</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Standard State</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseStandardState(StandardState object) {
		return null;
	}
