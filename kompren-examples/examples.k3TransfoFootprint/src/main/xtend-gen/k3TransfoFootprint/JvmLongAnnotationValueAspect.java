...
import k3TransfoFootprint.JvmLongAnnotationValueAspectJvmLongAnnotationValueAspectProperties;
import k3TransfoFootprint.K3TransfoFootprint;
import org.eclipse.xtext.common.types.JvmLongAnnotationValue;
import org.eclipse.xtext.xbase.lib.InputOutput;

@Aspect(className = JvmLongAnnotationValue.class)
@SuppressWarnings("all")
public class JvmLongAnnotationValueAspect extends JvmAnnotationValueAspect {
  @OverrideAspectMethod
  public static void _visitToAddClasses(final JvmLongAnnotationValue _self, final K3TransfoFootprint theSlicer) {
    k3TransfoFootprint.JvmLongAnnotationValueAspectJvmLongAnnotationValueAspectContext _instance = k3TransfoFootprint.JvmLongAnnotationValueAspectJvmLongAnnotationValueAspectContext.getInstance();
    				    java.util.Map<org.eclipse.xtext.common.types.JvmLongAnnotationValue,k3TransfoFootprint.JvmLongAnnotationValueAspectJvmLongAnnotationValueAspectProperties> selfProp = _instance.getMap();
    					boolean _containsKey = selfProp.containsKey(_self);
    				    boolean _not = (!_containsKey);
    				    if (_not) {
      						k3TransfoFootprint.JvmLongAnnotationValueAspectJvmLongAnnotationValueAspectProperties prop = new k3TransfoFootprint.JvmLongAnnotationValueAspectJvmLongAnnotationValueAspectProperties();
  ...
  public static JvmLongAnnotationValueAspectJvmLongAnnotationValueAspectProperties _self_;
  ...
  protected static void priv_visitToAddClasses(final JvmLongAnnotationValue _self, final K3TransfoFootprint theSlicer) {
    Class<? extends JvmLongAnnotationValue> _class = _self.getClass();
    String _plus = ("class: " + _class);
    String _plus_1 = (_plus + " in JvmLongAnnotationValue");
    InputOutput.<String>println(_plus_1);
    JvmLongAnnotationValueAspect.super__visitToAddClasses(_self, theSlicer);
  }
  ...
  protected static void priv_visitToAddRelations(final JvmLongAnnotationValue _self, final K3TransfoFootprint theSlicer) {
    Class<? extends JvmLongAnnotationValue> _class = _self.getClass();
    String _plus = ("relation: " + _class);
    String _plus_1 = (_plus + " in JvmLongAnnotationValue");
    InputOutput.<String>println(_plus_1);
    JvmLongAnnotationValueAspect.super__visitToAddRelations(_self, theSlicer);
  }
}
