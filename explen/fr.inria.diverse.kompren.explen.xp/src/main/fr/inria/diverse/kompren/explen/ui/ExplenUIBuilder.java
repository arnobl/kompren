...
import fr.inria.diverse.kompren.explen.Explen;
import fr.inria.diverse.kompren.explen.eval.Formular;
...
public class ExplenUIBuilder extends SwingUIComposer<ExplenFrame> {
	...
	public void compose(final MProgressBar progressBar) {
		...
		if(Explen.EVAL) {
			...
			formular = new Formular(qpanel, widget);
			qpanel.setFormular(formular);
		}
