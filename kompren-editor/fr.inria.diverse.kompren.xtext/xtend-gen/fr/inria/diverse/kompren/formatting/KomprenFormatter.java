 ...
 * generated by Xtext
 */
package fr.inria.diverse.kompren.formatting;
...
public class KomprenFormatter extends AbstractDeclarativeFormatter {
  @Inject
  @Extension
  private KomprenGrammarAccess _komprenGrammarAccess;
  
  protected void configureFormatting(final FormattingConfig c) {
    List<Pair<Keyword,Keyword>> _findKeywordPairs = this._komprenGrammarAccess.findKeywordPairs("{", "}");
    ...
    List<Keyword> _findKeywords = this._komprenGrammarAccess.findKeywords(",");
    ...
    TerminalRule _sL_COMMENTRule = this._komprenGrammarAccess.getSL_COMMENTRule();
    _setLinewrap.before(_sL_COMMENTRule);
    FormattingConfig.LinewrapLocator _setLinewrap_1 = c.setLinewrap(0, 1, 2);
    TerminalRule _mL_COMMENTRule = this._komprenGrammarAccess.getML_COMMENTRule();
    _setLinewrap_1.before(_mL_COMMENTRule);
    FormattingConfig.LinewrapLocator _setLinewrap_2 = c.setLinewrap(0, 1, 1);
    TerminalRule _mL_COMMENTRule_1 = this._komprenGrammarAccess.getML_COMMENTRule();
