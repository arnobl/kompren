		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getSlicerAccess().getGroup_5(), "rule__Slicer__Group_5__0");
					put(grammarAccess.getSlicerAccess().getGroup_9(), "rule__Slicer__Group_9__0");
					put(grammarAccess.getSlicerAccess().getGroup_10(), "rule__Slicer__Group_10__0");
					...
					put(grammarAccess.getSlicedClassAccess().getGroup_4(), "rule__SlicedClass__Group_4__0");
					...
					put(grammarAccess.getSlicedPropertyAccess().getGroup_6(), "rule__SlicedProperty__Group_6__0");
					...
					put(grammarAccess.getSlicerAccess().getUriMetamodelAssignment_5_2(), "rule__Slicer__UriMetamodelAssignment_5_2");
					put(grammarAccess.getSlicerAccess().getInputClassesAssignment_8(), "rule__Slicer__InputClassesAssignment_8");
					put(grammarAccess.getSlicerAccess().getInputClassesAssignment_9_1(), "rule__Slicer__InputClassesAssignment_9_1");
					put(grammarAccess.getSlicerAccess().getRadiusAssignment_10_2(), "rule__Slicer__RadiusAssignment_10_2");
					put(grammarAccess.getSlicerAccess().getSlicedElementsAssignment_11_2(), "rule__Slicer__SlicedElementsAssignment_11_2");
					put(grammarAccess.getSlicerAccess().getSlicedElementsAssignment_12_2(), "rule__Slicer__SlicedElementsAssignment_12_2");
					put(grammarAccess.getSlicerAccess().getOnStartAssignment_13_2(), "rule__Slicer__OnStartAssignment_13_2");
					put(grammarAccess.getSlicerAccess().getOnEndAssignment_14_2(), "rule__Slicer__OnEndAssignment_14_2");
					put(grammarAccess.getSlicerAccess().getHelperAssignment_15_2(), "rule__Slicer__HelperAssignment_15_2");
					...
					put(grammarAccess.getSlicedClassAccess().getConstraintsAssignment_4_2(), "rule__SlicedClass__ConstraintsAssignment_4_2");
					...
					put(grammarAccess.getSlicedPropertyAccess().getOppositeAssignment_2(), "rule__SlicedProperty__OppositeAssignment_2");
					put(grammarAccess.getSlicedPropertyAccess().getSrcAssignment_3(), "rule__SlicedProperty__SrcAssignment_3");
					put(grammarAccess.getSlicedPropertyAccess().getTgtAssignment_4(), "rule__SlicedProperty__TgtAssignment_4");
					put(grammarAccess.getSlicedPropertyAccess().getExpressionAssignment_5_1(), "rule__SlicedProperty__ExpressionAssignment_5_1");
					put(grammarAccess.getSlicedPropertyAccess().getConstraintsAssignment_6_2(), "rule__SlicedProperty__ConstraintsAssignment_6_2");
