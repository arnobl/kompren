...
/**
 * This is the item provider adapter for a {@link kompren.SlicedProperty} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SlicedPropertyItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(KomprenPackage.Literals.SLICED_PROPERTY__OPPOSITE);
			childrenFeatures.add(KomprenPackage.Literals.SLICED_PROPERTY__SRC);
			childrenFeatures.add(KomprenPackage.Literals.SLICED_PROPERTY__TGT);
		}
	...
	public String getText(Object object) {
		...
		return getString("_UI_SlicedProperty_type") +
				(domain==null ? "" : 
				" " + (domain.getEContainingClass()==null ? "?":domain.getEContainingClass().getName()) + " -> " + domain.getName());
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(KomprenPackage.Literals.SLICED_PROPERTY__OPPOSITE,
				 KomprenFactory.eINSTANCE.createOppositeCreation()));

		newChildDescriptors.add
			(createChildParameter
				(KomprenPackage.Literals.SLICED_PROPERTY__SRC,
				 KomprenFactory.eINSTANCE.createVarDecl()));

		newChildDescriptors.add
			(createChildParameter
				(KomprenPackage.Literals.SLICED_PROPERTY__TGT,
				 KomprenFactory.eINSTANCE.createVarDecl()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == KomprenPackage.Literals.SLICED_PROPERTY__SRC ||
			childFeature == KomprenPackage.Literals.SLICED_PROPERTY__TGT;
